...
export const profileUpdateSchema = z.object({
  ...
  avatarUrl: secureUrl('Invalid avatar URL', 2048).optional().nullable().or(z.literal('')),
  myBharatId: z.string().max(100).optional().nullable(),
  myBharatCertUrl: secureUrl('Invalid certificate URL', 2048).optional().nullable().or(z.literal('')),
});
...
export const eventPhotoSchema = z.object({
  url: secureUrl('Invalid photo URL', 2048),
