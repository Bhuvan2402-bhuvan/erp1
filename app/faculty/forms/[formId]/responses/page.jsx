    ...
    <div className="max-w-6xl mx-auto space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-4">
        <div className="flex items-center gap-3">
          <Link href={`/faculty/forms/${formId}/edit`} className="p-2 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-500 transition">
      ...
      <ResponseTable
        ...
        onRefresh={load}
        baseHref={`/faculty/forms/${formId}/responses`}
      />
    </div>
  );
}
